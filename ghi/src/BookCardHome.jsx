...
const BookCardHome = ({ book }) => {
    return (
    <Link to={book.work_id} className="container block max-w-full p-6 bg-orange-200 rounded-lg shadow hover:bg-orange-300 dark:bg-slate-800 dark:border-gray-700 dark:hover:bg-slate-600 animate-shad">
