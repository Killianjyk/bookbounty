...
const Nav = () => {
  ...
  <div className="flex-none">
    ...
    {user && <button onClick={() =>{logout(); navigate("/");}} className={"btn-danger"}>Logout</button>}
          <button onClick={handleThemeSwitch} id="theme-toggle" type="button" className="mx-4 bg-gray-400 hover:bg-gray-300 dark:hover:bg-gray-500 rounded-lg text-sm p-2.5">
