...
const Buttons = ({ work_id }) => {
    ...
    const { data: favorited, refetch: favoriteRefetch } = useGetFavoriteStatusQuery({username: user.username, work_id});
    const { data: queued, refetch: nextRefetch } = useGetNextStatusQuery({username: user.username, work_id});
    const { data: logged, refetch: prevRefetch } = useGetPreviousStatusQuery({username: user.username, work_id});
